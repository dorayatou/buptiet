/**
* touch.js
* @fileOverview 移动端touch事件
* @author Tim
* @version 1.0
* @date 2013-09-02
* @extends jquery.1.8.3
* @remark 针对于移动端web的click事件优化
*/
...
; (function ($) {
    ...
    var eventList = ['swipe', 'swipeLeft', 'swipeRight', 'swipeUp', 'swipeDown', 'doubleTap', 'tap', 'singleTap', 'longTap'];
    if (eventList.forEach) {
        eventList.forEach(function (m) {
