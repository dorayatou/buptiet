...
(function (exports, global) {
    ...
    /*加前缀->用户*/
    template.helper('fullPath', function (content) {
        if (content == "") {
            return CONFIG.URL.staticAll + "/img/wall/wechat_userico.png";
        } else {
            return CONFIG.URL.file + content;
        }
    });

    /*加前缀->奖品*/
    template.helper('prizeFullPath', function (content) {
        if (content == "") {
            return CONFIG.URL.staticAll + "/img/wall/screen/lottery_default.png";
        } else {
            return CONFIG.URL.file + content;
        }
    });
